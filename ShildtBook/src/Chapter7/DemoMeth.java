...
// для каждой геометрической фигуры в отдельности.
    ...
    public static void AbsShapes() {
        TwoDShapeAbstract shapes[] = new TwoDShapeAbstract[4];
        shapes[0] = new TriangleA("right", 8.0, 12.0);
        shapes[1] = new RectangleA(10);
        shapes[2] = new RectangleA(10, 4);
        shapes[3] = new TriangleA(7.0);
        for (int i = 0; i < shapes.length; i++) {
